function conv = steadystate_VSM_VC(conv,input)
...
sol_ss=fsolve(@(x)steadystate_nonlinear_VSM_VC(x,conv),[0,0],fsolve_options);
conv.ss.DeltaThetapll0 = sol_ss(1);
conv.ss.DeltaThetavsm0 = sol_ss(2);

conv.ss.ioq0 = 1./((conv.parameters.ls.*conv.parameters.rg-conv.parameters.lg.*conv.parameters.rs).*conv.ss.Omegag0.*cos(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0)+(conv.parameters.rg.*(conv.parameters.rg+conv.parameters.rs)+conv.parameters.lg.*(conv.parameters.lg+conv.parameters.ls).*conv.ss.Omegag0.^2).*sin(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0)).*(-(conv.parameters.lg+conv.parameters.ls).*conv.ss.vnq0.*conv.ss.Omegag0.*cos( ...
  conv.ss.DeltaThetapll0)+(conv.parameters.lg+conv.parameters.ls).*conv.ss.vnd0.*conv.ss.Omegag0.*sin(conv.ss.DeltaThetapll0)-conv.parameters.rg.*conv.ss.vnq0.*cos(conv.ss.DeltaThetavsm0).*sin(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0)+conv.parameters.rg.*conv.ss.vnd0.*sin(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0).*sin( ...
  conv.ss.DeltaThetavsm0)+conv.parameters.lg.*conv.ss.Omegag0.*cos(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0).*(conv.ss.vnq0.*cos(conv.ss.DeltaThetavsm0)-conv.ss.vnd0.*sin(conv.ss.DeltaThetavsm0)));
conv.ss.iod0 = 1./((conv.parameters.ls.*conv.parameters.rg-conv.parameters.lg.*conv.parameters.rs).*conv.ss.Omegag0.*cos(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0)+(conv.parameters.rg.*(conv.parameters.rg+conv.parameters.rs)+conv.parameters.lg.*(conv.parameters.lg+conv.parameters.ls).*conv.ss.Omegag0.^2).*sin(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0)).*((conv.parameters.rg+conv.parameters.rs).*conv.ss.vnq0.*cos(conv.ss.DeltaThetapll0)-( ...
  conv.parameters.rg+conv.parameters.rs).*conv.ss.vnd0.*sin(conv.ss.DeltaThetapll0)-conv.parameters.lg.*conv.ss.vnq0.*conv.ss.Omegag0.*cos(conv.ss.DeltaThetavsm0).*sin(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0)+conv.parameters.lg.*conv.ss.vnd0.*conv.ss.Omegag0.*sin(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0).*sin( ...
  conv.ss.DeltaThetavsm0)+conv.parameters.rg.*cos(conv.ss.DeltaThetapll0-conv.ss.DeltaThetavsm0).*(-conv.ss.vnq0.*cos(conv.ss.DeltaThetavsm0)+conv.ss.vnd0.*sin(conv.ss.DeltaThetavsm0)));
...
conv.ss.vpll0 = exp(1).^((1i*-1).*conv.ss.DeltaThetapll0).*(conv.ss.vnd0+1i.*conv.ss.vnq0+exp(1).^(1i.*conv.ss.DeltaThetavsm0).*conv.ss.io0.*(conv.parameters.rg+1i.*conv.parameters.lg.*conv.ss.Omegag0));
