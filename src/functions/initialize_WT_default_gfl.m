...
cvtr.ss.vnq0 = 0;                   
cvtr.ss.Omegag0 = 1;           
cvtr.ss.DeltaThetavsm_mech0=0;

switch cvtr.parameters.model_selector
    case 0
        cvtr.parameters.selector_current_reference = 0;
        cvtr.parameters.enable_pll = 0;
    ...
    case 1
        cvtr.parameters.selector_current_reference = 0;
        cvtr.parameters.selector_omega_reference = 0;
        cvtr.parameters.enable_pll = 1;
    ...
    case 2
        cvtr.parameters.selector_current_reference = 1;
        cvtr.parameters.selector_omega_reference = 0;
        cvtr.parameters.enable_pll = 0;
    ...
    case 4
        cvtr.parameters.selector_current_reference = 2;
        cvtr.parameters.selector_omega_reference = 0;
        cvtr.parameters.enable_pll = 0;
    ...
    case 6
        cvtr.parameters.selector_current_reference = 3;
        cvtr.parameters.selector_omega_reference = 1;
        cvtr.parameters.enable_pll = 1;
